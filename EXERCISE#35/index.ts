...
Animals: Think of at least three different animals that have a common
 characteristic. Store the names of these animals in a list, and then use
  a for loop to print out the name of each animal. • Modify your program to 
...
for (let i = 0; i < animals.length; i++) {
    console.log(`A ${animals[i]} is beneficial for human and can be kept as pets`)
}

console.log(' sheep, goat, and cow , are beneficial and give us milk and can be kept as pets.');
